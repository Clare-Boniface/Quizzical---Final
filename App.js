...
export default function App() {
    ...
    const handleStartQuizClick = () => {
        if (selectedTopic === "... Choose your speciality subject ...") {
    ...
    return (
        <div>
            {!showQuestions && !showAnswers && <Intro handleStartQuizClick={handleStartQuizClick} setTopic={setTopic} setSelectedTopic={setSelectedTopic} selectedTopic={selectedTopic} handleSelectCategory={handleSelectCategory} />}
